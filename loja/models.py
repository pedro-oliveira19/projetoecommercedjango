...
class Produto(models.Model):
    ...
    def total_vendas(self):
        itens = ItensPedido.objects.filter(pedido__finalizado=True, item_estoque__id=self.id)
...
class ItensPedido(models.Model):
    ...
    def __str__(self):
        return f"id_pedido: {self.pedido} - Produto: {self.item_estoque.produto.nome}, {self.item_estoque.tamanho}, {self.item_estoque.cor.nome}"
